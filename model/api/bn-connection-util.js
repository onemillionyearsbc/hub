 ...
 * your apps instead of the default airlinev9
 */
 module.exports = {
    ...
    connect : function(callback) {
        console.log("Trying to connect with card " + this.cardName);
        ...
        return this.connection.connect(this.cardName).then(function(){
            console.log("Connected ok using card " + this.cardName);
            callback();
        }).catch((error)=>{
            callback(error);
        });
